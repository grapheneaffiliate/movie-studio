...
dubbing, and virality. The full render-farm tool map is in `templates/models.md`.
...
- **`python3 scripts/qc.py projects/<slug>` exits 0** (no FAILs) — the automated
  Definition-of-Done gate; never deliver on a FAIL.
